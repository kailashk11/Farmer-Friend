<link rel="icon" href="farming.png" type="image/png" sizes="16x16"><!DOCTYPE html>
<html>
<head>
                    ...
                    <div class="block-content">
                        <div class="card p-3 pr-3">
                            <div class="media">
                                ...
                                <div class="media-body">
                                    <h4 class="card-title mbr-fonts-style display-5">How to use</h4>
                                </div>
                            </div>                

                            <div class="card-box">
                                <p class="block-text mbr-fonts-style display-7"><span style="font-size: 19.2px;">information</span><br></p>
                            </div>
                        </div>
                        ...
                        <div class="card p-3 pr-3">
                            <div class="media">
                                ...
                                <div class="media-body">
                                    <h4 class="card-title mbr-fonts-style display-5">Help</h4>
                                </div>
                            </div>                

                            <div class="card-box">
                                <p class="block-text mbr-fonts-style display-7">Information</p>
                            </div>
                        </div>
                    </div>
                </div>
          ...
          <div class="col-sm-4">
            <div class="footer-col-item">
              <h4>Quick Links</h4>
                ...
                <a href="temp/contact-us.html">Contact Us</a>
            </div>
          </div>
          <div class="col-sm-4">
            <div class="footer-col-item">
