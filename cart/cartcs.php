     ...
     <div class="container-fluid">
       ...
       <div class="collapse navbar-collapse" id="myNavbar">
         <ul class="nav navbar-nav">
           ...
           <li><a href="../e1.php">Equipments</a></li>

           <li ><a href="../c1.php">Crops</a></li>
             <li><a href="../ups.php">Upload</a></li>


         </ul>
         <ul class="nav navbar-nav navbar-right">
        <li class="active"><a href="../shop_prof.php"><?php 
...
$s2=$_SESSION['temp'];
  ...
  $row2 = mysqli_fetch_array($is_query_run);
    ...
    echo "welcome, ".$row2['NAME']; ?></a></li>
           ...
           <li><a href="../s1.php"><span class="glyphicon glyphicon-log-out"></span> Logout</a></li>
         </ul>
       </div>
     </div>
   ...
   $x=$_GET['id'];
   $query5 = "SELECT * FROM cropup where id = '$x'";
                        ...
                        <div class="box-body">
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                    <img src="<?php echo '../'.'img/'.$row2['crop_img']; ?>">
                                </div>
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                    <div class="product-single">
                                        <h2 style="font-size:300%;"><?php echo $row2['crop_name']; ?></h2>
                        ...
                        <div class="box-body">
                            ...
                            <div class="highlights">
                                <div class="row">
                                    ...
                                    <?php
                                    $t=$row2['Aadhar'];
    $query6 = "SELECT * FROM farmer_log where AADHAR = '$t'";
  ...
  $row3 = mysqli_fetch_array($is_query_run);
                                ...
                                <div class="row">
                                    ...
                                    <?php
                                    $t1=$_SESSION['temp'];
    $query6 = "SELECT * FROM shop_log where AADHAR = '$t1'";
  $is_query_run = mysqli_query($conn5,$query6);
  $row3 = mysqli_fetch_array($is_query_run);
