...
$s2=$_SESSION['temp'];
  ...
  $is_query_run = mysqli_query($conn,$query5);
  $row2 = mysqli_fetch_array($is_query_run);
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                    <div class="product-single">
                                        ...
                                        ?></h5>
                                        <button type="submit" class="btn btn-default" onclick="window.location.href='../payment/pay2.php';">BUY NOW</button>
  ...
  $is_query_run = mysqli_query($conn,$query6);
