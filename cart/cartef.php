...
$s2=$_SESSION['temp'];
  ...
  $row2 = mysqli_fetch_array($is_query_run);
   ...
   $x=$_GET['id'];
   $query5 = "SELECT * FROM equipup where id = '$x'";
                        ...
                        <div class="box-body">
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                    <img src="<?php echo '../'.'img1/'.$row3['eimg']; ?>">
                                </div>
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                    <div class="product-single">
                                        <h2 style="font-size:300%;"><?php echo $row3['ename']; ?></h2>
                                        
                                        
                                        <p class="product-price" style="font-size: 38px;"><?php echo $row3['price']."/-"; ?></p>
                                        <p></p>
                                        <div class="product-quantity">
                                            ...
                                            <input type="hidden" name="two" value="<?php echo $row3['price']; ?>">
                                                </form>
                                            </div>
  ...
  $row32 = mysqli_fetch_array($is_query_run);
     


                                    ?>
                                        <ul>
                                            <li style="color: #1c1e1e;"><?php echo $row32['NAME']; ?></li>
                                            <li style="color: #1c1e1e;"><?php echo $row32['CONTACT']; ?></li>
                                            <li style="color: #1c1e1e;"><?php echo $row32['ADDRESS']; ?></li>
                                            <li style="color: #1c1e1e;"><?php echo $row32['District']; ?></li>
                                ...
                                <div class="row">
                                    ...
                                    <?php
                                    $t1=$_SESSION['temp'];
    $query6 = "SELECT * FROM farmer_log where AADHAR = '$t1'";
  $is_query_run = mysqli_query($conn5,$query6);
  $row3 = mysqli_fetch_array($is_query_run);
     ...
     ?>
                                        <ul>
                                            ...
                                            <li style="color: #1c1e1e;"><?php echo $row3['MOBILE']; ?></li>
