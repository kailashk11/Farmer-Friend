...
<a href="c1.php" ><i class="fas fa-seedling"></i> Crops</a>
  <a href="ups.php" ><i class="fas fa-upload"></i> Upload</a>
...
$s=$_SESSION['temp'];
  ...
  $query = "SELECT * FROM shop_log where AADHAR = '$s'";
...
<table> <tr>
  ...
  <tr><?php
  $query1 = "SELECT * FROM equipup where Aadhar = '$s1'";
  ...
  ?>
    ...
    <td><?php echo $row1['ename']; ?>
    </td>
   <td><?php echo $row1['price']; ?></td>
    <td><?php echo $row1['quantity']; ?></td>
    <td><form action="" method="get">
<input type="hidden" name="id" value=<?php $id=$row1['id'];  echo $id;?>>
    <button type="submit" value="DELETE" name="go" class="btn btn-danger btn-sm" style="font-size:10px"></form></td>
  </tr>
...
if(isset($_GET['go'])) {
  $s1=$_GET['id'];
  $query = "DELETE FROM equipup where id = '$s1'";
