...
<a href="c1.php" ><i class="fas fa-seedling"></i> Crops</a>
  ...
  <a href="#" class="active"><i class="fas fa-upload"></i>Rent</a>
 ...
 <a href="javascript:void(0);" class="icon" onclick="myFunction()">
    ...
    <a style="float:right" href="s1.php"><span class="glyphicon glyphicon-log-out"></span> Logout</a>
     <a style="float:right" href="shop_prof.php"><?php 
      ...
      $conn2 = mysqli_connect("localhost","root","","crop");
$s2=$_SESSION['temp'];

  $query2 = "SELECT NAME FROM shop_log where AADHAR = '$s2'";
  $is_query_run = mysqli_query($conn2,$query2);
...
<center>
<form style="float:center" action="act.php" enctype="multipart/form-data" method="post">
