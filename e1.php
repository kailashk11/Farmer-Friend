...
<div class="topnav" id="myTopnav">
  ...
  <a href="#" class="active"><i class="fa fa-gears"></i> Equipments</a>
<a href="c1.php" ><i class="fas fa-seedling"></i> Crops</a>
  <a href="ups.php" ><i class="fas fa-upload"></i> Sell</a>
  
  <a href="rs.php" ><i class="fas fa-upload"></i> Rent</a> 
...
$s2=$_SESSION['temp'];
  ...
  $var1=$_GET['eqp'];
      ...
      if($var){
        if($var1){
          $query = "SELECT * FROM equipup,shop_log where equipup.Aadhar=shop_log.AADHAR AND shop_log.District='$var' AND equipup.ename='$var1'";
        }else{
          $query = "SELECT * FROM equipup,shop_log where equipup.Aadhar=shop_log.AADHAR AND shop_log.District='$var'";
        }
      }else{
        if($var1){
          $query = "SELECT * FROM equipup,shop_log where equipup.Aadhar=shop_log.AADHAR AND equipup.ename='$var1'";
        }
        $query = "SELECT * FROM equipup,shop_log where equipup.Aadhar=shop_log.AADHAR";
      }
  ...
  ?>
                          ...
                          <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 mb30">
                              <div class="product-block">
                                  <div class="product-img"><img src="<?php echo 'img1/'.$row['eimg']; ?>" alt="" style="height:200px"></div>
              ...
              <form action="cart/cartes.php" method="get">
